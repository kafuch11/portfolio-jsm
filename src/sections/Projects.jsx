...
const Projects = () => {
  ...
  return (
    <section className='c-space my-20' id="work">
      ...
      <div className="grid lg:grid-cols-2 grid-cols-1 mt-12 w-full gap-3">
        <div className='flex flex-col sm:p-10 py-10 gap-5 relative px-5 shadow-2xl'>
