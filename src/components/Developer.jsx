...
const {animations : idleAnimation} = useFBX('/models/animations/idle.fbx');
         ...
         const { actions } = useAnimations([idleAnimation[0],saluteAnimation[0],victoryAnimation[0],clappingAnimation[0]],groupRef);
         useEffect(()=>{ 
  ...
  return (
    <group ref={groupRef} scale={2.5} position={[0,-2,0]} {...props} dispose={null}>
